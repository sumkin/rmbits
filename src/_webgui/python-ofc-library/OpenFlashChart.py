...
class graph_object:
	def render( self, tab_name, width, height, data_url, swf_url_root=''):
		width = str(width)
		height = str(height)
                ret = "<object classid='clsid:d27cdb6e-ae6d-11cf-96b8-444553540000'\
                               ...
                               width='400'\
                               height='300'\
                               id='chart_obj_"+tab_name+"'\
                               align='middle'>\
                           <param name='allowScriptAccess' value='sameDomain' />\
                           <param name='movie' value='"+swf_url_root+"open-flash-chart.swf?width="+width+"&height="+height+"&data="+data_url+"'\
                                  id='param_movie_"+tab_name+"' />\
                           <param name='quality' value='high' />\
                           <param name='bgcolor' value='#FFFFFF' />\
                           <param name='wmode' value='transparent'>\
                         <embed src='"+swf_url_root+"open-flash-chart.swf?width="+width+"&height="+height+"&data="+data_url+"'\
                                quality='high'\
                                wmode='transparent'\
                                bgcolor='#FFFFFF'\
                                width='"+width+"'\
                ...
                return ret
                '''
		return """<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0" width="400" height="300" id="chart_obj" align="middle">
<param name="allowScriptAccess" value="sameDomain" />
<param name="movie" value="%sopen-flash-chart.swf?width=%s&height=%s&data=%s" id='param_movie' />
<param name="quality" value="high" /><param name="bgcolor" value="#FFFFFF" />
<param name="wmode" value="transparent">
<embed src="%sopen-flash-chart.swf?width=%s&height=%s&data=%s" quality="high" wmode='transparent' bgcolor="#FFFFFF" width="%s" height="%s" name="open-flash-chart" id="chart_embed" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
</object>"""%(swf_url_root,
				width,
				height,
				data_url,
