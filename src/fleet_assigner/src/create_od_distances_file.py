...
def create_file():
    df = pd.read_csv("s3://ay-rmp-home/fleet_assigner/input/airport_allowance.csv")
    ...
    s3copy("../output/od_distances.csv", "s3://ay-rmp-home/fleet_assigner/input/od_distances.csv")
