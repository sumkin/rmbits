...
with open('brexit_5th_us.csv', 'w') as fout:
    cw = csv.writer(fout)
    ...
    for i in range(400):
        ...
        bdf = pd.read_csv('s3://ay-rmp-home/nrm/brexit_5th_uscf/'+fcstyear+'/'+fcstmonth+'/'+fcstday+\
                                                    '/brexit_5th_uscf_'+fcstdate+'_'+depdate+'.csv.gz', low_memory = False)
