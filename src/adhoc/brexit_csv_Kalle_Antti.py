...
with open('brexit_Kalle_Antti.csv', 'w') as fout:
    cw = csv.writer(fout)
    ...
    for i in range(400):
        ...
        bdf = pd.read_csv('s3://ay-rmp-home/nrm/04_5th_Kalle_Antti_cf/'+fcstyear+'/'+fcstmonth+'/'+fcstday+\
                                             '/04_5th_Kalle_Antti_cf_'+fcstdate+'_'+depdate+'.csv.gz', low_memory = False)
