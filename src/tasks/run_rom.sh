...
export PYTHONPATH="/home/ay49514/rmbits/src/rom:$PYTHONPATH"

export LD_LIBRARY_PATH="${LD_LIBRARY_PATH}:${GUROBI_HOME}/lib"

python3 /home/ay49514/rmbits/src/tasks/daily/s3rom2csv.py
python3 /home/ay49514/rmbits/src/tasks/daily/s3roma2csv.py 
